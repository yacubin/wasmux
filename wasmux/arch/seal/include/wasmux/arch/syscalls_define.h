...
#define __SYSCALL_DEFINE0(name, prefix) \
  __EXPORT long sys_##name(void); \
  __EXPORT long __seal_sys_##name(void) \
  { \
    return sys_##name(); \
  } \
  prefix long sys_##name(void)

#define __SYSCALL_DEFINEx(x, name, prefix, ...) \
  ...
  prefix long sys_##name(__MAP(x, __SC_DECL, __VA_ARGS__))
...
#define WEAK_SYSCALL_DEFINE0(name)      __SYSCALL_DEFINE0(name, __ATTR_WEAK)
#define WEAK_SYSCALL_DEFINE1(name, ...) __SYSCALL_DEFINEx(1, name, __ATTR_WEAK, __VA_ARGS__)
#define WEAK_SYSCALL_DEFINE2(name, ...) __SYSCALL_DEFINEx(2, name, __ATTR_WEAK, __VA_ARGS__)
#define WEAK_SYSCALL_DEFINE3(name, ...) __SYSCALL_DEFINEx(3, name, __ATTR_WEAK, __VA_ARGS__)
#define WEAK_SYSCALL_DEFINE4(name, ...) __SYSCALL_DEFINEx(4, name, __ATTR_WEAK, __VA_ARGS__)
#define WEAK_SYSCALL_DEFINE5(name, ...) __SYSCALL_DEFINEx(5, name, __ATTR_WEAK, __VA_ARGS__)
#define WEAK_SYSCALL_DEFINE6(name, ...) __SYSCALL_DEFINEx(6, name, __ATTR_WEAK, __VA_ARGS__)
