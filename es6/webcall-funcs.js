module.exports = {
  ...
  sys_MemoryCopy(dst_mid, dst_offset, src_mid, src_offset, size) {
  ...
  sys_MemoryFill(mid, offset, value, length) {
    const bytes = new Uint8Array(this._objects[mid].buffer, offset, length);
    bytes.fill(value);
    return 0;
  },
  sys_MemoryStrnlen(mid, offset, length) {
  ...
  sys_MemoryStrncpy(dstMemory, dstOffset, srcMemory, srcOffset, count) {
  ...
  sys_CallObjectMethod(objectId, methodId) {
    const object = this._objects[objectId];
  ...
  sys_CallIntegerMethod(objectId, methodId) {
    const object = this._objects[objectId];
    const method = this._objects[methodId];
  ...
  sys_NumberCreate(value) {
    return this.createObjectId(value);
  },
  sys_GetObjectProperty(objectId, propId) {
    const object = this._objects[objectId];
  ...
  sys_GetIntegerProperty(objectId, propId) {
    const object = this._objects[objectId];
    const prop = this._objects[propId];
    return object[prop];
  },
  sys_SetObjectProperty(objectId, propId, valueId) {
    const object = this._objects[objectId];
    const prop = this._objects[propId];
  ...
  sys_SetIntegerProperty(objectId, propId, value) {
    const object = this._objects[objectId];
    const prop = this._objects[propId];
  ...
  sys_AddEventListener(objectId, typeId, callback, userdata) {
    const object = this._objects[objectId];
  ...
  sys_RemoveEventListener(objectId, typeId, listenerId) {
    const object = this._objects[objectId];
    const type = this._objects[typeId];
  ...
  sys_PromiseThen(objectId, resultCallback, errorCallback, userdata) {
    const object = this._objects[objectId];
  ...
  sys_WorkerPerform2(workerId, callback, userdata) {
    const worker = this._objects[workerId];
    worker.postMessage({
      type: 'perform',
      args: [
  ...
  sys_WorkerPerform3(workerId, callback, userdata, arg1) {
    const worker = this._objects[workerId];
    worker.postMessage({
      type: 'perform',
      args: [
  ...
  sys_WorkerPerform4(workerId, callback, userdata, arg1, arg2) {
    const worker = this._objects[workerId];
    worker.postMessage({
      type: 'perform',
      args: [
  ...
  sys_WorkerPerform5(workerId, callback, userdata, arg1, arg2, arg3) {
    const worker = this._objects[workerId];
    worker.postMessage({
      type: 'perform',
      args: [
  ...
  sys_PostMessage2(callback, userdata) {
    self.postMessage([
      callback,
      userdata,
    ]);
  },
  sys_PostMessage3(callback, userdata, arg1) {
    self.postMessage([
      callback,
      userdata,
      arg1 ? this._objects[arg1] : undefined,
  ...
  sys_PostMessage4(callback, userdata, arg1, arg2) {
    self.postMessage([
      callback,
      userdata,
      arg1 ? this._objects[arg1] : undefined,
  ...
  sys_PostMessage5(callback, userdata, arg1, arg2, arg3) {
    self.postMessage([
      callback,
      userdata,
      arg1 ? this._objects[arg1] : undefined,
  ...
  sys_PostMessage6(callback, userdata, arg1, arg2, arg3, arg4) {
    self.postMessage([
      callback,
      userdata,
      arg1 ? this._objects[arg1] : undefined,
